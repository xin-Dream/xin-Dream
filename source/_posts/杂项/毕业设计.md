...
> 毕业设计首先要继续完成对SLAM的实践部分，所以机器人的主要功能要在ROS平台中完成建图与导航的基本功能。开始接触人体行为检测。人体行为检测主要是在深度学习基础上完成对人体骨骼关键节点的检测，判断人的动作与行为。
> 本文会当作毕业设计的草稿。
...
10. [周等, 《轮足式仿人机器人行走机构设计与仿真分析》.](zotero://select/library/items/WN5S6XP8)
    ...
    2. <iframe src="//player.bilibili.com/player.html?aid=497852089&bvid=BV1fK411V7yZ&cid=181392909&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" height=400> </iframe>
...
11. [Gonzalez等, 《Dynamics and Aerial Attitude Control for Rapid Emergency Deployment of the Agile Ground Robot AGRO》.](zotero://select/library/items/HP8N7QV9)
    ...
    4. <iframe src="//player.bilibili.com/player.html?aid=287290586&bvid=BV1Vf4y1Q7Wo&cid=240154987&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" height=400> </iframe>

    ![image-20211113142314349](/images/毕业设计/image-20211113142314349.png)
    
12. [宋, 《四轮转向车辆操纵稳定性仿真分析》.](zotero://select/library/items/9EBT5P49)

    1. 四轮转向特点
    2. 横摆率反馈
    3. 忽略汽车侧倾与俯仰时的四轮转向动力学模型
    4. Matlab分析结论：保持车辆对操纵反应的灵敏、一致又不过度，在降低驾驶员操纵难度的情况下，改善了车辆在高速时的瞬态操纵稳定性
    5. 可用于写摘要或底盘设计时的引言

13. [屈等, 《基于模糊算法的四轮线控转向汽车操稳性研究》.](zotero://select/library/items/XTKJ27I9)

    1. [线控转向](https://zhuanlan.zhihu.com/p/381150351)
    2. 模糊转向补偿控制器，在提高快速性的同时能显著降低横摆角速度的超调量，有较强的稳定性

14. [李等, 《基于阿克曼理论的四轮转向汽车转向梯形优化设计》.](zotero://select/library/items/XPNHVB5T)

    1. 倒梯形布置时，转向梯形更容易满足传动角关系，误差更小

       ![image-20211116200740082](/images/毕业设计/image-20211116200740082.png)

    2. 正梯形极有可能出现四点，即横拉杆与转向节臂夹角为180°时不能继续转动

15. [李, 《轮轂电机驱动电动汽车的四轮转向操纵稳定性分析》.](zotero://select/library/items/R4KXVXEH)

    1. 模糊控制策略建立

    2. 操纵稳定性：前轮转向<四轮转向<**带有模糊控制的四轮转向**

       ![image-20211116201326972](/images/毕业设计/image-20211116201326972.png)

16. [郑, 《某轿车主动后轮转向系统转向电机控制研究》.](zotero://select/library/items/GB4KK2A4)

    1. 硕士论文**待精读**
    2. 发展现状对4WS介绍很全面

17. [陈, 《轮毂电机驱动的四轮转向样车试验及仿真研究》.](zotero://select/library/items/J23KV6JQ)

    1. 轮毂电机技术发展现状（至2020年5月30日）
    2. Carsim

18. [朱, 《基于多Agent框架的4WID电动汽车四轮主动转向控制及路径跟踪研究》.](zotero://select/library/items/4PXG4P5P)

    

19. [张, 《四轮转向车辆建模与转向稳定性研究》.](zotero://select/library/items/73J4EB83)

20. [胡, 《四轮独立驱动电动车差速转向性能研究》.](zotero://select/library/items/NV4DUZQN)

21. [陈, 《后轮随动转向车辆的半主动控制及智能随动转向系统研究》.](zotero://select/library/items/TW3BM9A9)

22. [韩, 《烟田作业车四轮转向系统的机构设计及转向控制》.](zotero://select/library/items/KTLNQ5M5)

23. [周, 《四轮转向系统控制策略对比研究》.](zotero://select/library/items/RVIBRIGM)

24. [刘, 《四轮转向汽车侧向动力学最优控制和内外环联合控制研究》.](zotero://select/library/items/ZQHJ9HA2)
...
1. {% post_link ROS/Solidworks模型导出urdf  Solidworks模型导出urdf %}
2. {% post_link ROS/控制sw2urdf导出模型在Rviz和Gazebo中运动  控制sw2urdf导出模型在Rviz和Gazebo中运动 %}


## 3.2 下位机

1. stm32中运行ROS节点：{% post_link ROS/在stm32中运行ROS节点-rosserial-stm32  在STM32F407中运行ROS节点 %}
1. 使用自定义消息实现ROS与stm32通讯：{% post_link ROS/使用自定义消息实现ROS与stm32通讯  使用自定义消息实现ROS与stm32通讯 %}

## 3.3 终端

### 3.3.1 基于PyQt5的GUI设计

1. {% post_link ROS/PyQt5开发ROS界面--Button实现Publish  PyQt5开发ROS界面1--Button实现Publish %}
2. {% post_link ROS/PyQt5开发ROS界面-使用滑条发布Twist消息  PyQt5开发ROS界面2-使用滑条发布Twist消息 %}
